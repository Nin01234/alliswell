        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {booking.services?.name} • {new Date(booking.booking_date).toLocaleDateString()} at{" "}
          ...
          <Card className="h-[600px] flex flex-col">
            <CardHeader className="border-b border-border">
              <CardTitle className="font-heading text-lg">
                Conversation with {booking.profiles?.full_name || "Photographer"}
              </CardTitle>
            </CardHeader>
                        ...
                        {!isCurrentUser && (
                          <Avatar className="h-8 w-8">
                            <AvatarFallback className="bg-primary text-white text-xs">
                              {isAdmin ? "📷" : message.profiles?.full_name?.charAt(0) || "U"}
                            </AvatarFallback>
                          </Avatar>
                        )}
                        <div
                          className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${
                            isCurrentUser ? "bg-primary text-white" : "bg-white border border-border text-foreground"
                          }`}
                        >
